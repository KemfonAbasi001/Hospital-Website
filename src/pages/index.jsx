...
// function Card(props) {
//     return(
//         <a href='' className="w-full relative overflow-hidden group rounded-2xl h-70 md:h-80 lg:h-92.5">
...
//           </h1>
//           <p className="text-[20px] lg:text-[18px] leading-6 lg:leading-7.7 font-normal text-[#faf6f6]">
//             Experience medicine reimagined — where cutting-edge technology,<br className='hidden md:block'/> world-renowned physicians, and unparalleled comfort converge to create<br className='hidden md:block'/> a sanctuary of healing.
//           </p>
...
function Card({ imgSrc, title, details }) {
  return (
    <a
      href=""
      className="w-full relative overflow-hidden group rounded-2xl h-72 md:h-80 lg:h-96"
    >
      <img
        src={imgSrc}
        alt={title}
      ...
      >
        <div className="flex flex-col gap-4 lg:gap-5 w-full max-w-3xl">
          ...
          <h1
            data-reveal
            data-delay="80"
            className="text-5xl leading-[48px] sm:text-6xl sm:leading-[60px] lg:text-7xl lg:leading-[72px] font-semibold text-white font-playfair"
          >
            Where Healing{' '}
      ...
      <section className="w-full pt-0 pb-16 lg:pb-24 flex justify-center">
        <div className="w-[93%] max-w-7xl flex flex-col gap-10 lg:gap-14">
          ...
          <div data-reveal>
            <a
              href="/services"
              className="block w-full sm:w-fit py-3 mx-auto px-10 lg:px-16 rounded-full border border-[#151c2833] text-sm lg:text-base text-black font-normal text-center hover:bg-[#f7f4ef] transition-colors duration-200"
            >
              View all Specialties
            </a>
          </div>
