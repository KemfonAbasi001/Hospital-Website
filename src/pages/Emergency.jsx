      ...
      >
        <div className="flex flex-col gap-3 lg:gap-4 w-[90%] md:w-[75%] lg:w-auto">
          <p
            data-reveal
            data-delay="0"
            className="text-[10px] md:text-[11px] lg:text-[12px] leading-4 tracking-[3.6px] font-medium text-[#F87171] uppercase flex items-center gap-2"
          >
          ...
          <h1
            data-reveal
            data-delay="80"
            className="text-[38px] md:text-[54px] lg:text-[72px] leading-tight lg:leading-18 font-semibold text-white font-playfair"
          >
            When Every <br /><span className="italic text-[#FCA5A5]">Second</span> Counts
          </h1>
          ...
          <p
            data-reveal
            data-delay="160"
            className="text-[14px] md:text-[16px] lg:text-[18px] leading-6 lg:leading-7.5 font-normal text-[#B3B3B3]"
          >
          ...
          <div data-reveal data-delay="240">
            <a
              href=""
              className="flex gap-0 mt-2 lg:mt-3 items-center text-[15px] lg:text-[18px] py-3 px-8 lg:px-12 rounded-3xl w-fit leading-7 font-medium text-white tracking-[.45px] bg-[#DC2626]"
            >
      ...
      <section className="w-full py-16 lg:py-30 flex justify-center items-center">
        <div className="w-[93%] flex gap-8 lg:gap-10 flex-col">
          ...
          <div className="flex flex-col gap-3 lg:gap-5 text-center w-full">
            <p
              data-reveal
              className="text-[10px] md:text-[11px] lg:text-[12px] leading-4 font-medium tracking-[3.6px] text-[#DDA23C] uppercase"
            >
              Get Help Now
            </p>
            <h2
              data-reveal
              data-delay="80"
              className="text-[28px] md:text-[34px] lg:text-[40px] leading-tight lg:leading-10 text-[#151C28] font-semibold font-playfair"
            >
              Choose How We Help You
            </h2>
          </div>
          ...
          <div className="grid w-full grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-12">
            ...
            {/* Card 1 — Dark */}
            <div data-reveal data-delay="0" className="flex flex-col gap-4 py-8 px-6 lg:py-9 lg:px-8 box-border bg-[#1c2b4a]">
              <div className="bg-[#dda23c33] text-[#d19f47] w-fit flex justify-center items-center p-4 rounded-full">
            ...
            {/* Card 2 — Light */}
            <div data-reveal data-delay="80" className="flex flex-col gap-4 py-8 px-6 lg:py-9 lg:px-8 box-border border border-solid border-[#dcdfe5]">
              <div className="bg-[#dda23c33] text-[#d19f47] w-fit flex justify-center items-center p-4 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6">
            ...
            {/* Card 3 — Light */}
            <div data-reveal data-delay="160" className="flex flex-col gap-4 py-8 px-6 lg:py-9 lg:px-8 box-border border border-solid border-[#dcdfe5] md:col-span-2 lg:col-span-1">
              <div className="bg-[#dda23c33] text-[#d19f47] w-fit flex justify-center items-center p-4 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6">
